...
import com.full.torrent.no.ads.private1.encrypted.core.filter.TorrentFilterCollection;
import com.full.torrent.no.ads.private1.encrypted.core.model.TorrentInfoProvider;
import com.full.torrent.no.ads.private1.encrypted.core.model.data.SessionStats;
...
import com.full.torrent.no.ads.private1.encrypted.receiver.NotificationReceiver;
...
import com.full.torrent.no.ads.private1.encrypted.ui.addtag.AddTagActivity;
import com.full.torrent.no.ads.private1.encrypted.ui.customviews.ExpansionHeader;
import com.full.torrent.no.ads.private1.encrypted.ui.detailtorrent.BlankFragment;
import com.full.torrent.no.ads.private1.encrypted.ui.detailtorrent.DetailTorrentActivity;
import com.full.torrent.no.ads.private1.encrypted.ui.detailtorrent.DetailTorrentFragment;
import com.full.torrent.no.ads.private1.encrypted.ui.feeds.FeedActivity;
import com.full.torrent.no.ads.private1.encrypted.ui.log.LogActivity;
import com.full.torrent.no.ads.private1.encrypted.ui.main.drawer.AbstractTagItem;
import com.full.torrent.no.ads.private1.encrypted.ui.main.drawer.DrawerExpandableAdapter;
import com.full.torrent.no.ads.private1.encrypted.ui.main.drawer.DrawerGroup;
import com.full.torrent.no.ads.private1.encrypted.ui.main.drawer.DrawerGroupItem;
import com.full.torrent.no.ads.private1.encrypted.ui.main.drawer.EmptyTagItem;
import com.full.torrent.no.ads.private1.encrypted.ui.main.drawer.NoTagsItem;
import com.full.torrent.no.ads.private1.encrypted.ui.main.drawer.TagItem;
import com.full.torrent.no.ads.private1.encrypted.ui.main.drawer.TagsAdapter;
import com.full.torrent.no.ads.private1.encrypted.ui.settings.SettingsActivity;
...
public class MainActivity extends AppCompatActivity implements FragmentCallback {
    ...
    public static final String ACTION_ADD_TORRENT_SHORTCUT = "com.full.torrent.no.ads.private1.encrypted.ADD_TORRENT_SHORTCUT";
    ...
    String license = "YOUR LICENSE KEY FROM GOOGLE PLAY CONSOLE HERE";
    String product = "YOUR PRODUCT ID FROM GOOGLE PLAY CONSOLE HERE";
    DonationManager dd;
    @Override
    ...
    private void initDrawer() {
        ...
        LinearLayout donater = findViewById(R.id.donater);
